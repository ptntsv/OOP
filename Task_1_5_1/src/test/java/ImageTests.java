...
public class ImageTests {
    ...
    public void commonTest() {
        Image.Builder im1 = new Image.Builder().withLink(
            new Link.Builder().withContent(new Text("Test")).withUrl("https://google.com").build());
    ...
    public void imagesEqTest() {
        Image.Builder im1 = new Image.Builder().withLink(
            new Link.Builder().withContent(new Text("First")).withUrl("https://first.com").build());
        Image.Builder im2 = new Image.Builder().withLink(
            new Link.Builder().withContent(new Text("Second")).withUrl("https://second.com")
                .build());
